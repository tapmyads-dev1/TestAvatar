...
class AuthenticateHandler
{
    ...
    func LoginWithCustomID(completionHandler:@escaping(Result<LoginWithCustomIDResult,Error>) -> Void)
    {
    ...
    func LoginWithEmailAddress(completionHandler:@escaping(Result<LoginWithEmailAddressResult,Error>) -> Void)
    {
        ApiBase.CallApi(completionHandler: { (response) in
            switch response
            {
    ...
    func LoginWithAndroidDeviceID (completionHandler:@escaping(Result<LoginWithAndroidDeviceIDResult,Error>) -> Void)
    {
        ApiBase.CallApi(completionHandler: { (response) in
            switch response
            {
    ...
    func LoginWithFacebook(completionHandler:@escaping(Result<LoginWithFacebookResult,Error>) -> Void)
    {
        ApiBase.CallApi(completionHandler: { (response) in
                switch response
                {
    ...
    func LoginWithIOSDeviceID(completionHandler:@escaping(Result<LoginWithIOSDeviceIDResult,Error>) -> Void)
    {
        ApiBase.CallApi(completionHandler: { (response) in
            switch response
            {
...
class LoginWithCustomID:Base
    ...
    {
        let loginWithCustomIDRequest = LoginWithCustomIDRequest(customID: customID, createAccount: createAccount)
        AuthenticationAPI.loginWithCustomID(loginWithCustomIDRequest: loginWithCustomIDRequest)
        {
            ...
            do
            {
                OpenAPIClientAPI.customHeaders = ["Authorization":"Bearer " + (response?.data?.accessToken)!]
...
class LoginWithIOSDeviceID:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        let loginWithIOSDeviceID = LoginWithIOSDeviceIDRequest(iOSDeviceID: iOSDeviceID,createAccount: createAccount)
        AuthenticationAPI.loginWithIOSDeviceID(loginWithIOSDeviceIDRequest: loginWithIOSDeviceID) { (response, error) in
            guard error == nil else {
                print(error!)
                completionHandler(.failure(error!))
                return
...
class LoginWithAndroidDeviceID:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        let loginWithAndroidDeviceIDRequest = LoginWithAndroidDeviceIDRequest(androidDeviceID: androidDeviceID,createAccount: createAccount)
        AuthenticationAPI.loginWithAndroidDeviceID(loginWithAndroidDeviceIDRequest: loginWithAndroidDeviceIDRequest ) { (response, error) in
            guard error == nil else {
                print(error!)
                completionHandler(.failure(error!))
                return
...
class LoginWithApple:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        let loginWithAppleRequest = LoginWithAppleRequest(appleID: appleID, createAccount: createAccount, appleIdentityToken: appleIdentityToken)
        AuthenticationAPI.loginWithApple(loginWithAppleRequest: loginWithAppleRequest){ (response, error) in
            guard error == nil else {
                print(error!)
                completionHandler(.failure(error!))
                return
...
class LoginWithEmailAddress:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        let loginWithEmailAddressRequest = LoginWithEmailAddressRequest(emailID: emailID,password: password)
        AuthenticationAPI.loginWithEmailAddress(loginWithEmailAddressRequest: loginWithEmailAddressRequest){ (response, error) in
            guard error == nil else {
...
class LoginWithFacebook:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        let LoginWithFacebookRequest = LoginWithFacebookRequest(facebookID: facebookID, fbAccessToken: fbAccessToken,createAccount:createAccount )
        AuthenticationAPI.loginWithFacebook(loginWithFacebookRequest:   LoginWithFacebookRequest){ (response, error) in
            guard error == nil else {
                print(error!)
                completionHandler(.failure(error!))
                return
...
class LoginWithGoogle:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        let loginWithGoogleRequest = LoginWithGoogleRequest(googleID: googleID, googleServerAuthCode: googleServerAuthCode,createAccount: createAccount)
        
        AuthenticationAPI.loginWithGoogle(loginWithGoogleRequest:   loginWithGoogleRequest){ (response, error) in
            guard error == nil else {
                print(error!)
                completionHandler(.failure(error!))
                return
...
class RegisterUser:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void)
    {
        let auth = RegisterUserRequest(emailID: emailID,password: password,displayName: addDisplayName)
