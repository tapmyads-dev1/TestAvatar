...
class AvatarManagementHandler
{
    ...
    func GetExpressionByID(completionHandler:@escaping(Result<GetExpressionByIDResult,Error>)->Void)
    {
        ApiBase.CallApi
        {
            response in
    ...
    func GrantAvatarPresetToUser(completionHandler:@escaping(Result<GrantAvatarPresetToUserResult,Error>) -> Void)
    {
        ApiBase.CallApi(completionHandler: { (response) in
            switch response
            {
    ...
    func GetAvatarPresets(completionHandler:@escaping(Result<GetAvatarPresetsResult,Error>) -> Void)
    {
        ApiBase.CallApi(completionHandler: { (response) in
            switch response
            {
    ...
    func GetAvatarPresetsByID(completionHandler:@escaping(Result<GetAvatarPresetByIDResult,Error>) -> Void)
    {
    ...
    func GrantAvatarPresetItemsToUser(completionHandler:@escaping(Result<GrantAvatarPresetItemsToUserResult,Error>) -> Void)
    {
        ApiBase.CallApi(completionHandler: { (response) in
            switch response
            {
    ...
    func GenerateAvatarMesh(completionHandler:@escaping(Result<GenerateAvatarMeshResult,Error>)->Void)
    {
        ApiBase.CallApi
        {
            response in
    ...
    func GetGetallbucketvertices(completionHandler:@escaping(Result<GetAllBucketVerticesResult,Error>) -> Void)
    {
        ApiBase.CallApi(completionHandler: { (response) in
            switch response
            {
    ...
    func RenderAvatarImage(completionHandler:@escaping(Result<RenderAvatarImageResult,Error>)->Void)
    {
        ApiBase.CallApi
        {
            response in
...
class GetAvatarPresets:Base
{
    ...
    init(status:AvatarManagementAPI.Status_getAvatarPresets,gender : AvatarManagementAPI.Gender_getAvatarPresets)
    {
        self.status = status
        self.gender = gender
    }
...
class GrantAvatarPresetItemsToUser:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        ...
        AvatarManagementAPI.grantAvatarPresetItemsToUser(grantAvatarPresetItemsToUserRequest: grantAvatarPresetItemsToUserRequest){ (response, error) in
            guard error == nil else {
                print(error!)
                completionHandler(.failure(error!))
                return
...
class GrantAvatarPresetToUser:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void)
    {
        ...
        AvatarManagementAPI.grantAvatarPresetToUser(grantAvatarPresetToUserRequest: grantAvatarPresetToUserRequest )
        {
            (response, error) in
            guard error == nil else
            {
...
class SyncAvatars:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void)
    {
        let request = SyncAvatarsRequest(platform: SyncAvatarsRequest.Platform.ios, mesh: Mesh, image: Image)
