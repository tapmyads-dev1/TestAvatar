...
class RecordAdsActivity:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        let recordAdsActivityRequest = RecordAdsActivityRequest(placementID: placementID, revenueCurrency: revenueCurrency,adRevenue: adRevenue)
        AdvertisingAPI.recordAdsActivity(recordAdsActivityRequest: recordAdsActivityRequest){ (response, error) in
...
class GrantAdsReward:Base
{
    ...
    func CallApi(completionHandler: @escaping (Result<AnyObject, Error>) -> Void) {
        ...
        AdvertisingAPI.grantAdsReward(grantAdsRewardRequest: grantAdsRewardRequest) { (response, error) in
            guard error == nil else {
                print(error!)
                completionHandler(.failure(error!))
                return
