...
struct UserDetails
{
    ...
    public var currentDevice:Platfroms?
    ...
    public init(userID:String? = nil, AccessToken:String? = nil, DisplayName:String? = nil, CreatedAt:String? = nil, emailId:String? = nil, currentDevice:Platfroms? = nil,
