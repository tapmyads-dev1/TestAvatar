...
public struct GetClipsByIDResultData: Codable, JSONEncodable, Hashable {
    ...
    public var customMetaData: [GetClipsByIDResultDataCustomMetaDataInner]?
    ...
    public init(displayName: String? = nil, description: String? = nil, category: String? = nil, customMetaData: [GetClipsByIDResultDataCustomMetaDataInner]? = nil, thumbnailsUrl: String? = nil, artifacts: String? = nil, tags: String? = nil, color: String? = nil, metadata: String? = nil, status: Int? = nil, clipType: Int? = nil, ID: String? = nil) {
